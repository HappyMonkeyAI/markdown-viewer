# Research links — Markdown Viewer

External references only. Not canonical. Prefer CONTEXT + ADRs + code.

| Topic | URL | Notes |
|-------|-----|--------|
| Agents Protocol | https://github.com/HappyMonkeyAI/AgentsProtocol | AGENTS, BOOTSTRAP, LTM layout |
...
| DOMPurify | https://github.com/cure53/DOMPurify | HTML sanitize |
| highlight.js | https://highlightjs.org/ | Code highlighting |

Sibling (local): `kb-vault-ui` — vault product; pattern source for Electron packaging only.
